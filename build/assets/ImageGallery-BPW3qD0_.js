import{a5 as K,$ as Q,f as V,j as l}from"./index-Ceg5H9Zi.js";var b={},L;function Y(){if(L)return b;L=1;function m(s){if(typeof window>"u")return;const n=document.createElement("style");return n.setAttribute("type","text/css"),n.innerHTML=s,document.head.appendChild(n),s}Object.defineProperty(b,"__esModule",{value:!0});var e=K();function j(s){return s&&typeof s=="object"&&"default"in s?s:{default:s}}var o=j(e);m(`.rfm-marquee-container {
  overflow-x: hidden;
  display: flex;
  flex-direction: row;
  position: relative;
